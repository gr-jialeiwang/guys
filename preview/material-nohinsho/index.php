...
<title>材料納品書照合 取引先選択：Guy's System</title>
				...
				<div class="container">
					<nav id="subNavTop" class="navKoji">
						<ul>
							...
							<li class="rightEnd currentLink"><a href="index.php">材料納品書照合</a></li>
						</ul>
					</nav>
					...
					<table class="tableA w371">
						<tbody>
							<tr>
								<th class="w75">取引先選択</th>
								<td class="w120">
									<select name="client" class="w145">
										<option>選択</option>
										<option value="すべて">すべて</option>
									</select>
								</td>
								<td class="bdl txtCenter">
									<a href="sansho/index.php" class="buttonA">表示する</a>
								</td>
							</tr>
						</tbody>
					</table>
