...
<title>立替金情報：Guy's System</title>
				...
				<div class="searchFocusArea">
					<table class="tableA3">
						<tr>
							...
							<td>
								<select name="constructionStates" class="w242">
							...
							<td>
								<select name="constructionCategory" class="w242">
									<option value="">選択しない</option>
									<option value="">未請求</option>
									<option value="">相殺請求済み</option>
									<option value="">回収済み</option>
								</select>
							</td>
							<th class="pr0">出金科目</th>
							<td>
								<select name="constructionType" class="w242">
									<option value="">選択しない</option>
									<option value=""></option>
									<option value=""></option>
								</select>
				...
				<table class="tableB">
					<tbody>
						<tr>
							...
							<td class="w70">前払い金</td>
							<td class="w70">100,000</td>
							<td class="w75">現金</td>
							<td class="w110">未請求</td>
							<td class="w80">-<br>-</td>
							<td class="w80">高橋 次郎</td>
							<td>◯◯◯◯◯◯◯◯◯◯◯◯◯◯◯</td>
							<td class="w25 txtCenter">
								<p class="iconLink"><a href="tatekaekin.php"><img src="../../img/common/icon_edit.png" height="26" width="26" alt="編集"></a></p>
							</td>
						</tr>
					</tbody>
				</table>
				<table class="tableB">
					<tbody>
						<tr>
							...
							<td class="w70">100,000</td>
							<td class="w75">現金</td>
							<td class="w110">相殺請求済み</td>
							<td class="w80">2015/12/25<br>小林 太郎</td>
							<td class="w80">高橋 次郎</td>
							<td>◯◯◯◯◯◯◯◯◯◯◯◯◯◯◯</td>
							<td class="w25 txtCenter">
								<p class="iconLink"><a href="tatekaekin.php"><img src="../../img/common/icon_edit.png" height="26" width="26" alt="編集"></a></p>
