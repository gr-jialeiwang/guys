						...
						<table class="tableA3">
							<tbody>
								...
								<tr>
									...
									<td>
										<select name="client" class="w218">
											<option value="選択しない">選択しない</option>
										</select>
									</td>
									<th>工事番号</th>
									<td><input type="text" class="w216" name="constructionNumber"></td>
									<td></td>
									<td></td>
								</tr>
							</tbody>
					...
					<table class="tableB">
						<thead>
							<tr>
								<th class="w63">申請者</th>
								<th class="w75">作業日</th>
								<th class="w85">工事番号</th>
								<th class="w120">工事ステータス</th>
								<th class="w120">取引先 <br>現場名</th>
								<th>作業内容</th>
								<th class="w60">開始時間 <br>完了時間</th>
								<th class="w53">時間数</th>
								<th class="w63">交通費</th>
								<th class="w63">承認管理者</th>
							</tr>
						</thead>
						<tbody>
							<tr>
								...
								<td><a href="../koji_search/index02_025.php" class="blue">0000B000-00</a></td>
								<td>工事完了／請求OK</td>
								<td>○○○不動産 <br>□□□□様邸</td>
								<td>□□□□□□□□</td>
								<td class="txtCenter">00:00 <br>00:00</td>
								<td class="txtRight">00:00</td>
