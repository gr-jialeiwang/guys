...
<title>労務申請一覧：Guy's System</title>
				...
				<table class="tableB">
					<thead>
						<tr>
							...
							<th class="w210">工務店<br>現場名</th>
							<th class="w154">作業内容</th>
							<th class="w53">開始時間<br>完了時間</th>
							<th class="w40">時間数</th>
							<th class="w40">交通費</th>
							<th class="w70">承認管理者<br>管理状況</th>
							<th class="w25">修正</th>
							<th class="w25">削除</th>
						</tr>
					</thead>
						...
						<table class="tableB">
							<tbody>
								<tr>
									...
									<td class="w210">○○○不動産<br>□□□□様邸</td>
									<td class="w154">□□□□□□□□</td>
									<td class="w53 txtCenter">00:00<br>00:00</td>
									<td class="w40 txtCenter">00:00</td>
									<td class="w40 txtCenter">0,000</td>
									<td class="w70">佐藤一郎<br>承認待ち</td>
									<td class="w25 txtCenter">
									<p class="iconLink"><a href="../shinsei/index.php"><img src="../../img/common/icon_edit.png" height="26" width="26" alt="修正"></a></p>
									</td>
									<td class="w25 txtCenter">
