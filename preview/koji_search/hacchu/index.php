			...
			<div class="container pt30">
				<div class="clearfix">
					<div class="boxLeft mr7">
						<a href="popup_001.php" class="buttonA">発注リスト（見込原価） プレビュー</a>
					</div>
					<div class="boxLeft mr7">
							...
							<tbody>
								<tr>
									...
									<td class="bdl txtCenter ">
										<a href="kobetsu.php" class="buttonA">発注書作成</a>
									</td>
								</tr>
							</tbody>
						</table>
					</div>
					<div class="boxRight w401">
						<table class="tableA noTtl">
							<tbody>
								<tr>
									<th class="w100">工事発注先選択</th>
									<td class="w175">
										<select name="representative" class="w175">
											<option>選択</option>
										</select>
									</td>
									<td class="bdl txtCenter">
										<a href="popup_001.html" target="_blank" class="buttonA">工事発注</a>
									</td>
								</tr>
							</tbody>
						</table>
					...
					<tr>
						<td class="bdl">
							<div class="clearfix">
								...
								<div class="boxLeft mr7">
									<select name="deliveryYear" class="w90">
										<option>年選択</option>
				...
				<table class="tableA3 w606">
					<tr>
						...
						<td class="bdl">
							<div class="clearfix">
								<div class="boxLeft mr7">仮発注書を訂正</div>
								<div class="boxLeft mr7">
									<button class="buttonA">実行</button>
								</div>
							</div>
					...
					<tr>
						<td class="bdl">
							<div class="clearfix">
								<div class="boxLeft mr7">仮発注書を削除</div>
								<div class="boxLeft mr7">
									<button class="buttonA">実行</button>
								</div>
							</div>
					...
					<table class="tableB">
						...
						<tbody>
							<tr>
								<td>
									<div class="checkBox">
										<input type="checkbox" name="order1-4" class="checkOrder" id="order1-4">
										<label for="order1-4"></label>
									</div>
								</td>
								<td class="txtCenter">0000/00/00<br>金子 靖子</td>
								<td class="txtCenter">ー<br>仮発注</td>
								<td>志水商店<br>ニチハ</td>
								<td>本体<br>─</td>
								<td>ＭＦＸ481<br>ー</td>
								<td class="txtCenter">材料<br>本体</td>
							...
							<tr>
								<td>
									<div class="checkBox">
										<input type="checkbox" name="order2-2" class="checkOrder" id="order2-2">
							...
							<tr>
								<td>
									<div class="checkBox">
										<input type="checkbox" name="order2-3" class="checkOrder" id="order2-3">
							...
							<tr>
								<td>
									<div class="checkBox">
										<input type="checkbox" name="order2-4" class="checkOrder" id="order2-4">
