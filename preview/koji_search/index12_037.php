...
<title>工事経費 工事経費 新規登録・編集：Guy's System</title>
...
<body>
	<div class="wrapper">
		...
		<form action="index.php" method="POST">
						...
						<div class="boxLeft">
							<nav id="kojiTab">
								<ul>
									...
									<li class="current"><a href="/koji_search/index12_037.php">工事経費</a></li>
								</ul>
							</nav>
						</div>
			...
			<div class="container">
				<div class="clearfix">
					<table class="tableA boxLeft w238 mt7">
						<thead>
							<tr>
								<th class="w87">工事経費合計</th>
				...
				<table class="tableA">
					<tr>
						<th class="w63">経費内容</th>
						<td class="w326"><input class="w100p" name="" value="○○○購入（□□□ホームセンター）" type="text"></td>
						<th class="w40">金額</th>
						<td class="w130"><input class="w100p txtRight" name="" value="3,240" type="text"></td>
						<th class="w40">備考</th>
						<td><input class="w100p" name="" type="text"></td>
						<td class="bdl w41">
					...
					<tr>
						<th>経費内容</th>
						<td><input class="w100p" name="" value="□□□□代" type="text"></td>
						<th>金額</th>
						<td><input class="w100p txtRight" name="" value="1,080" type="text"></td>
						<th>備考</th>
					...
					<tr>
						...
						<td><input class="w100p" name="" value="" type="text"></td>
						<th>金額</th>
						<td><input class="w100p txtRight"name="" value="" type="text"></td>
						<th>備考</th>
						<td><input class="w100p" name="" value="" type="text"></td>
						<td class="bdl">
							<a href="#" class="btnDecrease mr7">+</a>
