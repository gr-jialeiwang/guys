...
<body>
	<div class="wrapper">
		...
		<form action="index.php" method="POST">
			...
			<div class="container">
				<div class="headingB">
					<button class="buttonA">経理用 工事台帳 出力</button>
				</div>
				<table class="tableB">
					<thead>
						<tr>
							<th class="w110">粗利 <br>（売上金額－原価）</th>
							<th class="w87 bdr_black">粗利率 <br>（％）</th>
							<th class="bdr_black">原価 <br>（材料発注＋工事発注＋労務費＋工事経費）</th>
							<th class="w120">材料発注金額合計</th>
							<th class="w101">工事発注金額合計</th>
							<th class="w105">工事／労務費合計</th>
							<th class="w87">工事経費</th>
						</tr>
					</thead>
					<tbody>
						<tr>
							<td class="txtRight">00,000,000</td>
							<td class="txtRight bdr_black">00.0</td>
							<td class="txtRight bdr_black">00,000,000</td>
							<td class="txtRight">00,000,000</td>
							<td class="txtRight">00,000,000</td>
							<td class="txtRight">00,000,000</td>
				...
				<div class="clearfix">
					<div class="boxLeft w470">
						...
						<table class="tableA">
							<tr>
								<th class="txtCenter">請負金額</th>
								<th colspan="2" class="txtCenter">売上金額</th>
								<th class="txtCenter">未売上金</th>
							</tr>
							<tr>
								<td rowspan="3" class="txtRight">00,000,000</td>
								<td colspan="2" class="bdl txtRight">00,000,000</td>
								<td rowspan="3" class="bdl txtRight">00,000,000</td>
							</tr>
							<tr>
								<th class="txtCenter">入金額</th>
								<th class="txtCenter">未収売上金</th>
							</tr>
							<tr>
								<td class="txtRight">00,000,000</td>
							...
							<tr>
								<th colspan="2" class="txtCenter">請負未収金</th>
								<td colspan="2" rowspan="2" class="bdl txtRight"></td>
							</tr>
							<tr>
								<td colspan="2" class="txtRight">00,000,000</td>
							</tr>
						</table>
					</div>
					<div class="boxRight w470">
						...
						<table class="tableA">
							<tr>
								<th class="txtCenter">発注金額</th>
								<th colspan="2" class="txtCenter">仕入金額</th>
								<th class="txtCenter">未仕入金</th>
							</tr>
							<tr>
								<td rowspan="3" class="txtRight">00,000,000</td>
								<td colspan="2" class="bdl txtRight">00,000,000</td>
							...
							<tr>
								<th colspan="2" class="txtCenter">発注未払金</th>
								<td colspan="2" rowspan="2" class="bdl txtRight"></td>
							</tr>
							<tr>
								<td colspan="2" class="txtRight">00,000,000</td>
				...
				<table class="tableB">
					<thead>
						<tr>
							<th class="w73">日付</th>
							<th class="w60">種類</th>
							<th class="w115 bdr_black">社名</th>
							<th>請求額（税抜） <br>消費税</th>
							<th class="w87">請求額 税込合計</th>
							<th class="w87 bdr_black">入金</th>
							<th class="w111">受領請求額（税抜）<br> 消費税</th>
							<th class="w87">受領請求額 税込合計</th>
							<th class="w87 bdr_black">出金</th>
							<th class="w66">入出金科目</th>
						</tr>
					</thead>
					<tbody>
						<tr>
							<td class="txtCenter">0000/00/00</td>
							<td class="txtCenter">工務店</td>
							<td class="w115 bdr_black">○○○○○工務店</td>
							<td class="txtRight"></td>
							<td class="txtRight"></td>
							<td class="txtRight bdr_black">00,000,000</td>
							<td class="txtRight"></td>
							<td class="txtRight"></td>
							<td class="bdr_black txtRight"></td>
							<td class="txtCenter">普通預金</td>
						</tr>
						<tr>
							<td class="txtCenter">0000/00/00</td>
							<td class="txtCenter">商社</td>
							<td class="w115 bdr_black">■□■□■□■□</td>
							<td class="txtRight"></td>
							<td class="txtRight"></td>
							<td class="txtRight bdr_black"></td>
							<td class="txtRight"></td>
							<td class="txtRight"></td>
							<td class="bdr_black txtRight">00,000,000</td>
							<td class="txtCenter">振込み</td>
						</tr>
						<tr>
							<td class="txtCenter">0000/00/00</td>
							<td class="txtCenter">協力会社</td>
							<td class="w115 bdr_black">△△△△△</td>
							<td class="txtRight"></td>
							<td class="txtRight"></td>
							<td class="txtRight bdr_black"></td>
						...
						<tr>
							...
							<td class="txtRight">00,00,000</td>
							<td class="txtRight bdr_black"></td>
							<td class="txtRight"></td>
							<td class="txtRight" class="txtRight"></td>
							<td class="bdr_black txtRight"></td>
						...
						<tr>
							<td class="txtCenter">0000/00/00</td>
							<td class="txtCenter">自社</td>
							<td class="w115 bdr_black">社員職人</td>
							<td class="txtRight"></td>
							<td class="txtRight"></td>
							<td class="txtRight bdr_black"></td>
							<td class="txtRight"></td>
							<td class="txtRight"></td>
							<td class="bdr_black txtRight">00,000</td>
							<td class="txtCenter">ー</td>
						</tr>
						<tr>
							<td class="txtCenter">0000/00/00</td>
							<td class="txtCenter">自社</td>
							<td class="w115 bdr_black">工事経費</td>
							<td class="txtRight"></td>
							<td class="txtRight"></td>
							<td class="txtRight bdr_black"></td>
							<td class="txtRight"></td>
							<td class="txtRight"></td>
							<td class="bdr_black txtRight">0,000</td>
							<td class="txtCenter">ー</td>
						</tr>
					</tbody>
				</table>
