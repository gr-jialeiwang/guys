...
<title>見積書・発注書・完了報告一覧：Guy's System</title>
				...
				<table class="tableB">
					<thead>
						<tr>
							<th class="w73">発注日</th>
							<th class="w87">発行者</th>
							<th class="w115">発注先</th>
							<th class="w120">メーカー</th>
							<th class="w101">発注分類</th>
							<th class="w105">発注書No</th>
							<th class="w87">税抜発注額</th>
							<th class="w48">発注書</th>
							<th>発注明細書</th>
						</tr>
					</thead>
				...
				<table class="tableB">
					<tbody>
						<tr>
							...
							<td class="w87 txtCenter">佐藤太郎</td>
							<td class="w115 txtCenter"></td>
							<td class="w120"></td>
							<td class="w101 txtCenter">本発注</td>
							<td class="w105 txtRight"></td>
							<td class="w87 txtCenter">0,000,000</td>
							<td class="w48 txtCenter">
								<a href="#"><img src="../img/common/icon_pv.png" height="26" width="26" alt="PV"></a>
							</td>
							<td class="txtCenter">
				...
				<table class="tableB">
					<tbody>
						<tr>
							...
							<td class="w115 txtCenter"></td>
							<td class="w120"></td>
							<td class="w101 txtCenter">追加発注</td>
							<td class="w105 txtRight"></td>
							<td class="w87 txtCenter">0,000,000</td>
							<td class="w48 txtCenter">
								<a href="#"><img src="../img/common/icon_pv.png" height="26" width="26" alt="PV"></a>
				...
				<table class="tableB">
					<tbody>
						<tr>
							...
							<td class="w115 txtCenter"></td>
							<td class="w120"></td>
							<td class="w101 txtCenter">仮発注</td>
							<td class="w105 txtRight"></td>
							<td class="w87 txtCenter">0,000,000</td>
							<td class="txtCenter">
								<p class="iconLink"><a href="#"><img src="../img/common/icon_pv.png" height="26" width="26" alt="PV"></a></p>
				...
				<table class="tableB">
					<tbody>
						<tr>
							<td class="w73 txtCenter">0000/00/00</td>
							<td class="w87 txtCenter">佐藤太郎</td>
							<td class="w145 txtCenter">受注／正式追加見積り</td>
							<td>
								<ul class="horizontal">
									<li class="pt4 mr7">
				...
				<table class="tableB">
					<tbody>
						<tr>
							<td class="w73 txtCenter">0000/00/00</td>
							<td class="w87 txtCenter">佐藤太郎</td>
							<td class="w145 txtCenter">受注／正式見積り</td>
							<td>
								<ul class="horizontal">
									<li class="pt4 mr7">
										<button class="buttonA pt5">破棄</button>
				...
				<table class="tableB">
					<tbody>
						<tr>
							<td class="w73 txtCenter"></td>
							<td class="w87 txtCenter"></td>
							<td class="w145 txtCenter">未受注／初期見積り</td>
							<td class="txtCenter"></td>
					</tbody>
				</table>
				<div class="headingB">
