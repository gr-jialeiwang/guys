	...
	<div class="wrapper">
		...
		<form action="index.php" method="POST">
						...
						<div class="boxLeft">
							<nav id="kojiTab">
								<ul>
									...
									<li class="current"><a href="index.php">実行原価</a></li>
			...
			<div class="container pt30">
				...
				<div class="headingB mt10">
					<h3>材料の部</h3>
				</div>
				<table class="tableB mb10">
					<thead>
						<tr>
							<th class="w73">原価計算項目</th>
							<th class="w184">品名 <br>品番</th>
							<th class="w159">仕様／規格／摘要</th>
							<th>発注先 <br>メーカー</th>
							<th class="w100">発注書No <br>発注書作成者</th>
							<th class="w30 ">数量 <br>単位</th>
							<th class="w72">単価</th>
							<th class="w87">合計</th>
					...
					<tbody>
						<tr>
							<td class="txtCenter">本体</td>
							<td>□□□□□□□□ <br>000ABC000</td>
							<td>□□□□□□□□</td>
							<td class="txtCenter">○○○○商事 <br>□□□</td>
							<td class="txtCenter"><a href="#" class="blue">0000-000-0000 </a><br>山本 太郎</td>
							<td class="txtCenter ">000 <br>本</td>
							<td class="txtRight">00,000</td>
							<td class="txtRight">0,000,000</td>
							<td class="txtCenter">0000/00/00 <br>0000/00/00</td>
						</tr>
						<tr>
							<td class="txtCenter">本体</td>
							<td>□□□□□□□□ <br>000ABC000</td>
							...
							<td class="txtRight">00,000</td>
							<td class="txtRight">0,000,000</td>
							<td class="txtCenter">0000/00/00 <br>-</td>
						</tr>
						<tr>
							<td class="txtCenter">本体</td>
							<td>□□□□□□□□ <br>000ABC000</td>
				...
				<table class="tableA w260">
					<tr>
						<th class="w87">合計（税別）</th>
						<td class="txtRight">00,000,000</td>
					</tr>
				</table>
				<div class="headingB mt10">
				...
				<table class="tableB mb10">
					<thead>
						<tr>
							...
							<th class="w80">作業日</th>
							<th>作業内容</th>
							<th class="w100">開始時間 <br>完了時間</th>
							<th class="w51">時間数</th>
							<th class="w60">労務費計</th>
							<th class="w72">交通費</th>
							<th class="w87">承認管理者</th>
						</tr>
					</thead>
					<tbody>
						<tr>
							<td class="txtCenter">山本 太郎</td>
							<td class="txtCenter">0000/00/00</td>
							<td>□□□□□□□□</td>
							<td class="txtCenter">00:00 <br>00:00</td>
							<td class="txtCenter">00：00</td>
							<td class="txtCenter">00,000</td>
							<td class="txtRight">0,000</td>
							<td class="txtCenter">佐藤 一郎</td>
						</tr>
						<tr>
							<td class="txtCenter">山本 太郎</td>
							<td class="txtCenter">0000/00/00</td>
				...
				<table class="tableA w260">
					<tr>
						<th class="txtCenter w111">合計（非課税）</th>
						<td class="txtRight">00,000,000</td>
					</tr>
				</table>
				<table class="tableA w260">
					<tr>
						<th class="txtCenter w111">工事経費合計 <br>（その他諸経費）</th>
						<td class="txtRight">00,000,000</td>
					</tr>
				</table>
			</div>
