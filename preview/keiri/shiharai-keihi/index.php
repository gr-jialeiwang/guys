...
<title>支払経費一覧：Guy's System</title>
					...
					<div class="boxRight">
						<table class="tableA">
							<tr>
								...
								<th>合計金額</th>
								<td>
									<input type="text" name="totalAmount" placeholder="※AUTO">
								</td>
							</tr>
						</table>
					</div>
					...
					<table class="tableB">
						<thead>
							<tr>
								<th class="w75">支払日</th>
								<th class="w53">種別</th>
								<th class="w200">支払先</th>
								<th class="w111">支払金額</th>
					...
					<table class="tableB">
						<tbody>
							<tr>
								...
								<td class="w53 txtCenter">単発</td>
								<td class="w200">□□□□□□□□□□□</td>
								<td class="w111 txtRight">00,000,000</td>
								<td class="w75 txtCenter">普通預金</td>
								<td></td>
							</tr>
						</tbody>
					</table>
