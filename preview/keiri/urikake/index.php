			...
			<section class="pageTop pb20">
				<div class="container">
					...
					<table class="tableA w663">
						<tr>
							<th class="w80">対象月 選択</th>
							<td class="w167">
								<ul class="dateSortingArea horizontal">
									<li>
										<select name="urikakeYear" class="w87">
											<option>年選択</option>
										...
										<select name="urikakeMonth" class="w72 mr0">
											<option>月選択</option>
							...
							<td class="w145">
								<select name="urikakeSelect" class="w145">
									<option value="">請求日ベース</option>
									<option value="">完了日ベース</option>
								</select>
							</td>
							<td class="bdl txtCenter">
								<a href="info.php" class="buttonA">表示する</a>
							</td>
						</tr>
					</table>
				</div>
