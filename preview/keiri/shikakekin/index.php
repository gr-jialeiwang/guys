...
<title>仕掛金（未成工事支出金）一覧：Guy's System</title>
				...
				<div class="container">
					...
					<table class="tableA">
						<tr>
							...
							<td class="w210">
								<select name="client" class="w210">
									<option value="すべて">すべて</option>
								</select>
							</td>
							<th class="w63">集計選択</th>
							<td>
								<select name="tally" class="w167">
									<option value="完了・納品ベース">完了・納品ベース</option>
								</select>
							</td>
						</tr>
					</table>
					<table class="tableA">
						<tr>
							<th class="w124">工事完了日選択</th>
							<td class="w294">
								<ul class="dateSortingArea horizontal">
									<li>
										<select name="completionYear" class="w105">
											<option>年選択</option>
							...
							<td class="bdl txtCenter">
								<a href="monitor.php" class="buttonA">表示する</a>
							</td>
						</tr>
					</table>
				</div>
