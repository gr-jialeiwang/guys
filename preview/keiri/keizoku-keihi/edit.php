...
<title>継続経費 新規登録・編集：Guy's System</title>
			...
			<div class="container">
				...
				<table class="tableA">
					<tr>
						...
						<th class="w63">支払日</th>
						<td class="w263">
							<ul class="dateSortingArea horizontal w263">
								<li>
									...
									<select name="paymentDueDay" class="w72 mr0">
										<option>日選択</option>
						...
						<th class="w75">毎月</th>
						<td>
							<select name="daySelect" class="w100p">
								<option>日選択</option>
							</select>
						</td>
					</tr>
				...
				<table class="tableA">
					<tr>
						<th class="w63">支払金額</th>
						<td class="w216"><input type="text" name="paidAmound" class="w216"></td>
						<th class="w63">出金科目</th>
						<td class="w263">
							<select name="accountTitle" class="w263">
								<option></option>
							</select>
						</td>
						<th class="w75">ステータス</th>
						<td>
							<select name="state" class="w100p">
