...
<title>入金予定表：Guy's System</title>
	...
	<div class="wrapper">
		...
		<form action="index.php" method="POST">
			...
			<div class="container">
				...
				<table class="tableA w454">
					<tbody>
						<tr>
							<th class="w80">対象月選択</th>
							<td class="w234" colspan="2">
								<ul class="dateSortingArea horizontal">
									<li>
										<select name="yearStart" class="w87">
											<option>年選択</option>
						...
						<tr>
							...
							<td class="bdl txtCenter">
								<a href="spc-month.php" class="buttonA">表示する</a>
							</td>
						</tr>
					</tbody>
				</table>
				...
				<table class="tableA w454">
					<tbody>
							...
							<td class="w234" colspan="2">
								<ul class="dateSortingArea horizontal">
									...
									<li>
										...
										<select name="monthEnd" class="w72 mr0">
											<option>月選択</option>
											<option value="1月">1月</option>
											<option value="2月">2月</option>
											<option value="3月">3月</option>
						...
						<tr>
							...
							<td class="bdl txtCenter">
								<a href="month.php" class="buttonA">表示する</a>
							</td>
						</tr>
					</tbody>
				</table>
