...
<!--{else}-->
	...
	<!--{else}-->
		...
		<!--{/if}-->
		<form name="form1" action="?<!--{if $mode != "index" && $mode != "newRegist"}-->codeNumber=<!--{$codeNumber}-->&officeCode=<!--{$officeCode}--><!--{/if}-->" method="POST">
			...
			<section class="pageTop">
				<div class="container">
					<div class="pageTitle clearfix">
						...
						<div class="boxRight<!--{if $mode == "index" || $mode == "newRegist"}--> disp_none<!--{/if}-->" id="client_del_single">
					...
					<table class="tableA">
						<tr>
							<th class="w87">企業名</th>
							<td>
								<select name="codeNumber" class="w363"<!--{if $mode != "index" && $mode != "newRegist"}--> disabled="disabled"<!--{/if}-->>
					...
					<table class="tableA">
						<tr>
							...
							<td>
								<input type="text" class="w135" name="officeCode" placeholder="000A00-00" value="<!--{$select.officeCode}-->"<!--{if $mode != "index" && $mode != "newRegist"}--> disabled="disabled"<!--{/if}-->>
								<!--{if $mode != "index" && $mode != "newRegist"}-->
