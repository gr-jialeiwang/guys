...
<!--{else}-->
	...
	<!--{else}-->
		...
		<form name="form1" action="?" method="POST">
			<input type="hidden" name="FN_func" value="base" />
				...
				<div class="container">
					...
					<table class="tableA">
						<tr>
							...
							<td>
								<!--{$select.staffID}-->
								<!--<input type="text" name="staffID" class="w100p" value="<!--{$select.staffID}-->" disabled="disabled">-->
								<input type="hidden" name="staffID" class="w100p" value="<!--{$select.staffID}-->">
							</td>
							<th class="w63">所属</th>
		...
		<form name="form2" action="?" method="POST">
			<input type="hidden" name="FN_func" value="system" />
			<input type="hidden" name="mode" id="mode" value="<!--{$editMode}-->" />
			<input type="hidden" name="FN_staffIDOrg" value="<!--{$staffID}-->" />
			<input type="hidden" name="FN_systemIDOrg" value="<!--{$systemID}-->" />
		<!--{/if}-->
